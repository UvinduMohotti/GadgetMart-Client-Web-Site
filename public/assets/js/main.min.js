!function (e) {
    ...
    var t = {
        initialised: !1, mobile: !1, init: function () {
            ...
            var t = !1, i = null, a = null, o = function (t, i) {
                ...
                if (992 > e(window).width()) t && i.each(function (t) {
                    ...
                    t || function () {
                        ...
                        a = [], i = e(".sticky-header").each(function () {
                            var t = e(this), i = t.data("sticky-options"), n = {};
                    ...
                    i.each(function (i) {
                        ...
                        n + s >= l.offset + l.paddingTop ? (r.hasClass("fixed") || function (t, i, a) {
                            ...
                            }), t.addClass("fixed").css("top", -i.height).animate({top: a}))
            ...
            e(".mmenu-btn").on("click", function (t) {
                var i = e(this).closest("li"), a = i.find("ul").eq(0);
            ...
            a.each(function () {
                ...
                e("body").on("click", "a.btn-quickview1", function (i) {
            ...
            e(".login-link").click(function (i) {
                ...
                setTimeout(function () {
                    e.magnificPopup.open({
                        ...
                        preloader: !1,
                        removalDelay: 350,
                        items: {src: "ajax/login-popup.php"},
                        callbacks: {
                            open: function () {
                                if (e(".sticky-header.fixed")) {
                                    var t = Number(e(".sticky-header.fixed").css("margin-right").slice(0, -2)) + 17 + "px";
            ...
            var i = e("[data-parallax]"), a = {speed: 1.5, horizontalPosition: "50%", offset: 0, enableOnMobile: !0};
            i.length && i.each(function () {
                var i = e(this), o = i.data("parallax");
                o && (o = JSON.parse(o.replace(/'/g, '"').replace(";", "")));
                var n, s, r, l, c = e.extend(!0, {}, a, o), d = e(window);
                ...
                if (l.css({
                    ...
                    width: "100%",
                    height: 100 * c.speed + "%"
                }), i.prepend(l), i.css({position: "relative", overflow: "hidden"}), !t.mobile || c.enableOnMobile) {
                    var p = function () {
            ...
            if (e.fn.appear) {
                ...
                e('.owl-item [data-animation-name="splitRight"]').each(function () {
                    var t = e(this).text(), i = e(this).data("animation-delay") ? e(this).data("animation-delay") : "0";
                    e(this).text("");
                    for (var a = t.length - 1; a >= 0; a--) e(this).prepend('<div class="d-inline-block appear-animate" data-animation-delay="' + (i + 90 * a) + '">' + (" " === t[a] ? "&nbsp" : t[a]) + "</div>")
            ...
            e(".grid").each(function () {
                var i = e(this), a = i.data("grid-options");
                a && (a = JSON.parse(a.replace(/'/g, '"').replace(";", "")));
                var o = e.extend(!0, {}, t, a), n = i.isotope(o);
                if (o.sortReorder) {
                    var s = function () {
                        var t = e(window).width();
                        n.isotope({sortBy: t < 768 && t > 400 ? "md-order" : "original-order"})
                    };
