                    ...
                    <div class="col-lg-5">
                        <div class="about-slider owl-carousel owl-theme">
                            <div class="about-slider-item">
                                <img class="owl-lazy" data-src="{{ URL::asset('assets/images/about/img-1.jpg')}}" src="{{ URL::asset('assets/images/lazy.png')}}" alt="About image description">
                            </div>
                            <div class="about-slider-item">
                                <img class="owl-lazy" data-src="{{ URL::asset('assets/images/about/img-2.jpg')}}" src="{{ URL::asset('assets/images/lazy.png')}}" alt="About image description">
                            </div>
                            <div class="about-slider-item">
                                <img class="owl-lazy" data-src="{{ URL::asset('assets/images/about/img-3.jpg')}}" src="{{ URL::asset('assets/images/lazy.png')}}" alt="About image description">
                            </div>
